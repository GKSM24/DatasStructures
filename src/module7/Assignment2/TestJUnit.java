...
public class TestJUnit {
    ...
    public void testCase1() {
        ...
        List<String> arr = Arrays.asList("L","P","M","X","H","C","R","A","E","S");
        String res = "";
        for(String s: arr){
            res += s + " ";
        }
        ...
        arr = Arrays.asList("L","P","M","H","C","R","A","E","S","X");
        res = "";
        for(String s: arr){
            res += s + " ";
        }
        ...
        arr = Arrays.asList("L","P","M","H","C","R","A","S","X","E");
        res = "";
        for(String s: arr){
            res += s + " ";
        }
        ...
        arr = Arrays.asList("L","P","M","H","R","A","S","X","E","C");
        res = "";
        for(String s: arr){
            res += s + " ";
        }
        ...
        arr = Arrays.asList("L","M","H","R","A","S","X","E","C","P");
        res = "";
        for(String s: arr){
            res += s + " ";
        }
