package StudentReservationSystem;
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        while(i < no_of_testcases){
            String inputFile = "C:\\Users\\Gopi Venkat Krishna\\IdeaProjects\\DatasStructures\\src\\StudentReservationSystem\\testcases\\input00"+i+".txt";
            String outputFile = "C:\\Users\\Gopi Venkat Krishna\\IdeaProjects\\DatasStructures\\src\\StudentReservationSystem\\testcases\\output00"+i+".txt";
